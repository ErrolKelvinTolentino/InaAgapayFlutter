...
class MidwifeUltrasoundDetailsPage extends StatelessWidget {
  final VoidCallback onBack;

  const MidwifeUltrasoundDetailsPage({
    super.key,
        ...
        child: Column(
          children: [
            ...
            const AiAnalyticsCard(
              text:
                  'Ultrasound findings are consistent with the expected gestational age. '
